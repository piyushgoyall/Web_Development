...
class FoodList extends Component {
  ...
  radioSelect = (selected) => {
    ...
    if (
      this.state.prevRestraunt.length > 0 &&
  ...
  render() {
    return (
      <div style={styles.itemWidth}>
        <Card style={styles} className="flexItem">
          <CardContent>
            ...
            {this.props.isMostOrdered ? (
              <ReactPlaceholder
                ...
                color="#E0E0E0"
              >
                <Typography component="p" className="mostOrdered">
                  {" "}
                  Popular
                </Typography>
              </ReactPlaceholder>
            ) : (
              <div style={styles.itemNotMostOrdered}></div>
            )}
            <br />
            {this.state.isModalOpened ? (
              ""
            ...
            <Typography variant="headline" component="h2" className="itemName">
              {this.props.name}
            </Typography>
            <Typography component="p" style={styles.italian}>
              Italian
            </Typography>
            <br />
            {this.state.isModalOpened ? (
