    ...
    return (
      <div>
        <AppBar position="static" className="headerMain">
          <Toolbar>
            ...
            <span
              ...
              className={
                this.props.isHovered ? "searchBoxExtended" : "searchBox"
              }
            >
              <FontAwesomeIcon
                icon="search"
                className={
                  this.props.isHovered ? "searchIconExtended" : "searchIcon"
                }
              />
              <input
                type="text"
            ...
            >
              {this.props.cartCount > 0 ? (
                <div>
                  ...
                  <br />
                  <MenuItem onClick={this.props.checkOut}>
        ...
        {this.props.isOrdered ? (
          <AddressForm modalClose={this.props.closeAddressModal} />
        ) : null}
      </div>
    );
  }
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    handleClick: (event) =>
      dispatch(actionCreators.handleClick(event.currentTarget)),
